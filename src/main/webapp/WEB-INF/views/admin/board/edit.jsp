				...
				<div class="container-fluid">
					<div align="center" style="padding: 10px">
						<div class="col-md-12">
							<!-- card -->
							<div class="card"
								style="width: 100%; padding: 30px 30px 60px 30px; text-align: left">
									...
									<div class="row" align="center">
										...
										<div class="col-md-10" style="padding: 0px 0 0 0">
												...
												<div class="row" style="width: 100%">
													...
													<div style="width: 50%; text-align: right">
														<div class="row" style="float: right">
															<table>
																<tr>
																	<td><select id="" name="category"
																		class="form-control"
																		style="width: 100%; font-size: 100%; height: 30px">
																	...
																	<td><input type="text"
																		style="width: 100%; width: 150px; height: 30px">
																	</td>
																	<td>
																		<button class="simplebtn1"
																			style="width: 70px; height: 30px">검색</button>
																		<button class="simplebtn2"
																			style="width: 70px; height: 30px">글쓰기</button>
																	</td>
																</tr>
															</table>
														</div>
											...
											<table class="table-hover" id="listtable"
												style="width: 100%; font-size: 100%; text-align: center">
												<thead>
												...
												<tbody>
													...
													<tr>
														...
														<td style="text-align: left">9월 회식비용 영수증 <img
															src="${root}/assets/img/icon_new1.gif"></td>
														<td>손예진</td>
														<td>18.10.02</td>
														<td>234</td>
														<td><a href="#">추가</a></td>
							...
							<div class="card-action" style="text-align: center">
								<button class="btn btn-default" onclick="javascript:submit()"
									style="width: 120px; padding: 10px; margin: 5px">선택삭제</button>
								<button class="btn btn-success" onclick="javascript:submit()"
									style="width: 120px; padding: 10px; margin: 5px">수정완료</button>
								<button class="btn btn-danger" onclick="javascript:goback()"
									style="width: 120px; padding: 10px; margin: 5px">수정취소</button>
							</div>
							<!-- register form end-->
						</div>
					</div>
