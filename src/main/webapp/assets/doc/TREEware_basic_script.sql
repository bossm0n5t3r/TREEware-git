...
ALTER TABLE BRD_LIST
	DROP
		CONSTRAINT FK_CATEGOTY_TO_BRD_LIST
		CASCADE;
...
COMMENT ON TABLE CATEGOTY IS '카테고리';

COMMENT ON COLUMN CATEGOTY.CCODE IS '카테고리번호';

COMMENT ON COLUMN CATEGOTY.CNAME IS '카테고리이름';

ALTER TABLE CATEGOTY
	ADD
		CONSTRAINT PK_CATEGOTY
		PRIMARY KEY (
			CCODE
		);
