...
ALTER TABLE BRD_LIST
    DROP
        CONSTRAINT FK_BRD_TYPE_TO_BRD_LIST
        CASCADE;

ALTER TABLE BRD_LIST
    DROP
        CONSTRAINT FK_CATEGORY_TO_BRD_LIST
        CASCADE;
...
COMMENT ON COLUMN BRD.BCODE IS '게시판번호';
...
CREATE TABLE ADDR (
    ...
    ADDR_TEL VARCHAR2(100), /* 휴대전화 */
    ADDR_EMAIL VARCHAR2(100), /* 이메일주소 */
    ADDR_CPN_TEL VARCHAR2(100), /* 회사전화 */
    ADDR_ADDR VARCHAR2(100), /* 주소 */
...
COMMENT ON COLUMN ADDR.ADDR_TEL IS '휴대전화';

COMMENT ON COLUMN ADDR.ADDR_EMAIL IS '이메일주소';

COMMENT ON COLUMN ADDR.ADDR_CPN_TEL IS '회사전화';

COMMENT ON COLUMN ADDR.ADDR_ADDR IS '주소';
...
CREATE TABLE ML (
    ...
    ML_SEND_DATE VARCHAR2(100) NOT NULL, /* 보낸날짜 */
...
CREATE TABLE CMT (
    ...
    CMT_DATE VARCHAR2(100) NOT NULL, /* 날짜 */
    CMT_STR_TM VARCHAR2(100), /* 출근시간 */
    CMT_END_TM VARCHAR2(100), /* 퇴근시간 */
    CMT_WOUT_TM VARCHAR2(100), /* 외근 */
    CMT_GOUT_TM VARCHAR2(100), /* 외출 */
    CMT_CB_TM VARCHAR2(100) /* 복귀 */
);
...
CREATE TABLE APV (
    ...
    APV_DATE VARCHAR2(100), /* 시행일자 */
    APV_WRITE_DATE VARCHAR2(100), /* 작성일 */
    APV_TITLE VARCHAR2(100) /* 문서제목 */
);
...
COMMENT ON COLUMN APV.APV_DATE IS '시행일자';

COMMENT ON COLUMN APV.APV_WRITE_DATE IS '작성일';

COMMENT ON COLUMN APV.APV_TITLE IS '문서제목';
...
COMMENT ON TABLE BRD_LIST IS '게시판리스트';

COMMENT ON COLUMN BRD_LIST.BCODE IS '게시판번호';

COMMENT ON COLUMN BRD_LIST.BNAME IS '게시판이름';

COMMENT ON COLUMN BRD_LIST.BTYPE IS '게시판형식번호';

COMMENT ON COLUMN BRD_LIST.CCODE IS '카테고리번호';

ALTER TABLE BRD_LIST
    ADD
        CONSTRAINT PK_BRD_LIST
        PRIMARY KEY (
            BCODE
        );

/* 게시판형식 */
CREATE TABLE BRD_TYPE (
    BTYPE NUMBER NOT NULL, /* 게시판형식번호 */
    BTYPE_NAME VARCHAR2(100) /* 게시판형식이름 */
);

COMMENT ON TABLE BRD_TYPE IS '게시판형식';

COMMENT ON COLUMN BRD_TYPE.BTYPE IS '게시판형식번호';

COMMENT ON COLUMN BRD_TYPE.BTYPE_NAME IS '게시판형식이름';

ALTER TABLE BRD_TYPE
    ADD
        CONSTRAINT PK_BRD_TYPE
        PRIMARY KEY (
            BTYPE
        );
...
CREATE SEQUENCE "DPT_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 6 NOCACHE NOORDER NOCYCLE;

-- 직책번호 SEQ
DROP SEQUENCE "PST_SQ";
CREATE SEQUENCE "PST_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 7 NOCACHE NOORDER NOCYCLE;

-- 권한번호 SEQ
DROP SEQUENCE "PMS_SQ";
CREATE SEQUENCE "PMS_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 3 NOCACHE NOORDER NOCYCLE;

-- 직위번호 SEQ
DROP SEQUENCE "RNK_SQ";
CREATE SEQUENCE "RNK_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 7 NOCACHE NOORDER NOCYCLE;

-- 일정번호 SEQ
DROP SEQUENCE "SCD_SQ";
CREATE SEQUENCE "SCD_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 사원번호 SEQ
DROP SEQUENCE "EMP_SQ";
CREATE SEQUENCE "EMP_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 23 NOCACHE NOORDER NOCYCLE;

-- 메일그룹번호 SEQ
DROP SEQUENCE "ML_GRP_SQ";
CREATE SEQUENCE "ML_GRP_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 4 NOCACHE NOORDER NOCYCLE;

-- 메일번호 SEQ
DROP SEQUENCE "ML_SQ";
CREATE SEQUENCE "ML_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 출퇴근번호 SEQ
DROP SEQUENCE "CMT_SQ";
CREATE SEQUENCE "CMT_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 메일상태번호 SEQ
DROP SEQUENCE "ML_STT_SQ";
CREATE SEQUENCE "ML_STT_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 3 NOCACHE NOORDER NOCYCLE;

-- 결재승인번호 SEQ
DROP SEQUENCE "APV_OK_SQ";
CREATE SEQUENCE "APV_OK_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 5 NOCACHE NOORDER NOCYCLE;

-- 문서번호 SEQ / 10001 ~ 19999
DROP SEQUENCE "APV_SQ";
CREATE SEQUENCE "APV_SQ" MINVALUE 1 MAXVALUE 19999 INCREMENT BY 1 START WITH 10001 NOCACHE NOORDER NOCYCLE;

-- 결재양식분류번호 SEQ
DROP SEQUENCE "APV_FORM_DIV_SQ";
CREATE SEQUENCE "APV_FORM_DIV_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 5 NOCACHE NOORDER NOCYCLE;

-- 결재양식번호 SEQ
DROP SEQUENCE "APV_FORM_SQ";
CREATE SEQUENCE "APV_FORM_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 게시판구분번호 SEQ
DROP SEQUENCE "BRD_DIV_SQ";
CREATE SEQUENCE "BRD_DIV_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 게시글번호 SEQ
DROP SEQUENCE "BRD_SQ";
CREATE SEQUENCE "BRD_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 리플번호 SEQ
DROP SEQUENCE "RPL_SQ";
CREATE SEQUENCE "RPL_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

-- 주소록번호 SEQ
DROP SEQUENCE "ADDR_SQ";
CREATE SEQUENCE "ADDR_SQ" MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 21 NOCACHE NOORDER NOCYCLE;
...
-- 결재승인
INSERT INTO APV_OK (APV_OK_SQ, APV_OK_NM) VALUES (0, '반려');
INSERT INTO APV_OK (APV_OK_SQ, APV_OK_NM) VALUES (1, '진행중');
INSERT INTO APV_OK (APV_OK_SQ, APV_OK_NM) VALUES (2, '1차결재');
INSERT INTO APV_OK (APV_OK_SQ, APV_OK_NM) VALUES (3, '2차결재');
INSERT INTO APV_OK (APV_OK_SQ, APV_OK_NM) VALUES (4, '최종승인');

-- 결재양식분류
INSERT INTO APV_FORM_DIV (APV_FORM_DIV_SQ, APV_FORM_DIV_NM) VALUES(1, '기안');
INSERT INTO APV_FORM_DIV (APV_FORM_DIV_SQ, APV_FORM_DIV_NM) VALUES(2, '시행');
INSERT INTO APV_FORM_DIV (APV_FORM_DIV_SQ, APV_FORM_DIV_NM) VALUES(3, '휴가');
INSERT INTO APV_FORM_DIV (APV_FORM_DIV_SQ, APV_FORM_DIV_NM) VALUES(4, '경력');
...
VALUES ('2018021',1,3,1,1,'한정희','grand','grand','F','1977-03-03','grand','@grand.com',
        '010','5391','1624','15611','서울특별시','노원구',SYSDATE,SYSDATE);

INSERT INTO EMP (EMP_SQ,PMS_SQ,DPT_SQ,RNK_SQ,PST_SQ,EMP_NM,EMP_ID,EMP_PW,EMP_SEX,EMP_BDATE,
                 EMP_ML_ID,EMP_ML_ADDR,EMP_TEL1,EMP_TEL2,EMP_TEL3,EMP_ZIP,EMP_ADDR,EMP_ADDR_DT,
                 EMP_REG,EMP_FNL_MOD)
VALUES ('2018022',1,3,4,5,'황수빈','hwang','hwang','F','1995-03-03','hwang','@hwang.com',
        '010','8844','9999','05060','서울특별시','관악구',SYSDATE,SYSDATE);

-- 메일함
INSERT INTO ML_GRP VALUES(1, '받은메일함');
INSERT INTO ML_GRP VALUES(2, '보낸메일함');
INSERT INTO ML_GRP VALUES(3, '휴지통');

-- 메일상태
INSERT INTO ML_STT VALUES(1,'읽음');
INSERT INTO ML_STT VALUES(2,'안읽음');
...
VALUES(1, 120181, '김지훈', '010-1234-5678', 'abc@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(2, 120181, '강기현', '010-9012-3456', 'def@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(3, 120181, '이훈', '010-7890-1234', 'ghi@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(4, 120181, '최재현', '010-5678-9012', 'jkl@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(5, 120181, '정이훈', '010-3456-7890', 'mno@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(6, 120181, '한효현', '010-1234-5678', 'pqr@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(7, 120181, '이명훈', '010-9012-3456', 'stu@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(8, 120181, '박명현', '010-7890-1234', 'vwx@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(9, 120181, '조영훈', '010-5678-9012', 'yza@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(10, 120181, '유영현', '010-3456-7890', 'bcd@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(11, 120181, '김재훈', '010-1234-5678', 'efg@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(12, 120181, '강재현', '010-9012-3456', 'hij@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(13, 120181, '이정훈', '010-7890-1234', 'klm@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(14, 120181, '최정현', '010-5678-9012', 'nop@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(15, 120181, '정명훈', '010-3456-7890', 'qrs@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(16, 120181, '한영현', '010-1234-5678', 'tuv@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(17, 120181, '이영훈', '010-9012-3456', 'wxy@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(18, 120181, '박호현', '010-7890-1234', 'zab@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(19, 120181, '조호훈', '010-5678-9012', 'cde@abc.com', '02-1234-5678', '', '');

INSERT INTO ADDR(ADDR_SQ, ADDR_GRP_SQ, ADDR_NM, ADDR_TEL, ADDR_EMAIL, ADDR_CPN_TEL, ADDR_ADDR, ADDR_MM)
VALUES(20, 120181, '유명현', '010-3456-7890', 'fgh@abc.com', '02-1234-5678', '', '');
